describe('Домашнее задание к занятию 1.3 «Типы данных»', () => {
  describe('Задача №1. Функция должна:', () => {
  ...
  describe('Задача №2. Функция должна:', () => {
    it('верно приветствовать анонима при незаданном имени ', () => {
      expect(getGreeting()).toEqual('Привет, мир! Меня зовут Аноним.');
    });

    it('верно приветствовать анонима при имени, равном пустой строке', () => {
      expect(getGreeting('')).toEqual('Привет, мир! Меня зовут Аноним.');
    });

    it('верно приветствовать пользователя при известном имени', () => {
